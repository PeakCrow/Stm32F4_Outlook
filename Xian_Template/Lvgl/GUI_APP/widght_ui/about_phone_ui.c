...
static void About_Phone_In_Ui(lv_obj_t* parent)
{
    ...
    lv_obj_set_style_text_font(Fatfs_label,font,LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(Author_label,font,LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(Ls_label,font,LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(Hadware_label,font,LV_PART_MAIN);
