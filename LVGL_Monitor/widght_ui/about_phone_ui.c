...
void About_Phone_Ui(lv_obj_t *parent)
{
    ...
    lv_imgbtn_set_src(Imgbtn_MC,LV_STATE_DEFAULT,NULL,"D:/Ls_Monitor_Lower/LVGL_Monitor/images/about_phone.png","D:/Ls_Monitor_Lower/LVGL_Monitor/images/about_phone.png");
#else
...
static void Imgbtn_MC_cb(lv_event_t * e)
{
    ...
    if(code == LV_EVENT_RELEASED)
         About_Phone_In_Ui(App_Common_Init("About_Phone",App_btn_Back_Cb));
}
...
static void About_Phone_In_Ui(lv_obj_t* parent)
{
    ...
    lv_obj_align(Lvgl_label,LV_ALIGN_TOP_LEFT,screen_left_pos,1*45);
    lv_label_set_text_fmt(Lvgl_label,"current_lvgl_version #ff0000 %d.%d.%d#",LVGL_VERSION_MAJOR,LVGL_VERSION_MINOR,LVGL_VERSION_PATCH);
    ...
    lv_obj_align(Fatfs_label,LV_ALIGN_TOP_LEFT,screen_left_pos,2*40);
    lv_label_set_text_fmt(Fatfs_label,"current_fatfs_revision_id #ff0000 %d#",_FATFS);
    ...
    lv_obj_align(Threadx_label,LV_ALIGN_TOP_LEFT,screen_left_pos,3*40);
    lv_label_set_text_fmt(Threadx_label,"azure_rtos_threadx_version #ff0000 %d.%d.%d#",THREADX_MAJOR_VERSION,THREADX_MINOR_VERSION,THREADX_PATCH_VERSION);
    ...
    lv_obj_align(Author_label,LV_ALIGN_TOP_LEFT,screen_left_pos,4*40);
    lv_label_set_text_fmt(Author_label,"software_and_hardware_author #ff0000 runxian.tian#");
    ...
    lv_obj_align(Ls_label,LV_ALIGN_TOP_LEFT,screen_left_pos,5*40);
    lv_label_set_text_fmt(Ls_label,"ls_racing_fleet #00ff00 E01#");
    ...
    lv_obj_align(Hadware_label,LV_ALIGN_TOP_LEFT,screen_left_pos,6*40);
    ...
    lv_obj_align(Hallib_label,LV_ALIGN_TOP_LEFT,screen_left_pos,7*40+20);
    lv_label_set_text_fmt(Hallib_label,"stm32f4xx_cmsis_version #ff0000 %d.%d.%d.%d#",__STM32F4xx_CMSIS_VERSION_MAIN,__STM32F4xx_CMSIS_VERSION_SUB1,__STM32F4xx_CMSIS_VERSION_SUB2,__STM32F4xx_CMSIS_VERSION_RC);
    ...
    lv_obj_align(Monitor_label,LV_ALIGN_TOP_LEFT,screen_left_pos,8*40+20);
    lv_label_set_text_fmt(Monitor_label,"hardware_version #ff0000 %d.%d.%d#",HARDWARE_MAJOR_VERSION,HARDWARE_MINOR_VERSION,HARDWARE_PATCH_VERSION);
    ...
    lv_obj_set_style_line_color(About_line1,lv_palette_main(LV_PALETTE_PURPLE),LV_PART_MAIN);
    ...
    lv_obj_set_style_line_color(About_line2,lv_palette_main(LV_PALETTE_PURPLE),LV_PART_MAIN);
    ...
    lv_obj_set_style_line_color(About_line3,lv_palette_main(LV_PALETTE_PURPLE),LV_PART_MAIN);
