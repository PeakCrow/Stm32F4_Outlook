...
void Cool_Control_Ui(lv_obj_t *parent)
{
    ...
    lv_imgbtn_set_src(Imgbtn_MC,LV_STATE_DEFAULT,NULL,"D:/Ls_Monitor_Lower/LVGL_Monitor/images/cool_control.png","D:/Ls_Monitor_Lower/LVGL_Monitor/images/cool_control.png");
#else
